/**
 * Pre-generate OpenAPI specification at build time.
 * 
 * This script runs swagger-jsdoc against the source TypeScript files
 * and outputs the spec as a static JSON file that can be served in production
 * (where source files are not available in the standalone build).
 * 
...
// Write spec to public directory so it's available in production
